...
const typeFilters = [
  ...
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2">
        {/* Vertical eclipse alabaster sconce */}
...
export default function ShopCategories({ activeType = "all", onSelect }) {
  return (
        ...
        {typeFilters.map((type) => {
          ...
          return (
            ...
            >
              {/* Circle container */}
              <div 
                className={`w-18 h-18 md:w-20 md:h-20 rounded-full flex items-center justify-center border transition-all duration-300 relative ${
                  isActive
